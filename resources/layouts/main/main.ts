/*
    ...
    MainLayout.fullscreen() will maximize the current area
    MainLayout.fullscreen( false ) will return it to normal
*/

namespace MainLayout {

    // The most important feature of the site //////////////////////////////////
    ...
    /**
     * Sets the container to take up the whole screen, or returns it to normal.
     *
     * @param {boolean} [active=true] If true, maximizes the container,
     *      otherwise returns it.
     */
    export const fullscreen = function (active: boolean = true): void {
        const eMain = document.getElementById("main--body");
        if (active) {
